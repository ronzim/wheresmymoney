...
- [x] Sistema di checkpoint per riprendere il lavoro in corso - WIP
- [ ] Inserire nel contesto dell'LLM un csv con i dati categorizzati dell'anno scorso per migliorare la precisione
- [ ] Inserire nel system prompt una descrizione delle categorie e delle nostre vite (dove lavoriamo etc) 
